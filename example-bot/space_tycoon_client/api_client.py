...
from space_tycoon_client.exceptions import ApiTypeError, ApiValueError, ApiException
from space_tycoon_client.model_utils import (
    ModelNormal,
    ModelSimple,
    ModelComposed,
...
class Endpoint(object):
    ...
    def __call__(self, *args, **kwargs):
        ...
        api_instance = CommandsApi()
        api_instance.commands_post  # this is an instance of the class Endpoint
        api_instance.commands_post()  # this invokes api_instance.commands_post.__call__()
        which then invokes the callable functions stored in that endpoint at
        api_instance.commands_post.callable or self.callable in this class
