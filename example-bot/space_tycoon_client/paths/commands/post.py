...
# body param
SchemaForRequestBody = Commands


request_body_commands = api_client.RequestBody(
    content={
...
class BaseApi(api_client.Api):
    ...
    def _commands_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_commands.serialize(body, content_type)
