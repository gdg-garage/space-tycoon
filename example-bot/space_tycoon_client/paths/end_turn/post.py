...
from space_tycoon_client import api_client, exceptions
...
# body param
SchemaForRequestBody = EndTurn


request_body_end_turn = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = CurrentTick
...
class BaseApi(api_client.Api):
    ...
    def _end_turn_post(
        ...
        _fields = None
        _body = None
        serialized_data = request_body_end_turn.serialize(body, content_type)
