...
from space_tycoon_client.exceptions import ApiException, ApiValueError
...
class RESTClientObject(object):
    ...
    def __init__(self, configuration, pools_size=4, maxsize=None):
        ...
        # Custom SSL certificates and example-bot certificates: http://urllib3.readthedocs.io/en/latest/advanced-usage.html  # noqa: E501
